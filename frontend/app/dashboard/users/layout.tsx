  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <div className="relative">
        ...
        {/* Sidebar */}
        <aside
          className={`fixed top-20 right-0 h-[calc(100vh-80px)] w-64 bg-white shadow-xl
        ...
        >
          <nav className="p-6 space-y-2">
              ...
              {listingOpen && (
                <div className="mt-1 pl-4 space-y-1">
                  <Link
                    ...
                    className="block px-4 py-2 rounded-lg transition hover:bg-blue-100 text-blue-900 text-sm"
                  >
                    همه آگهی‌ها
                  </Link>
                </div>
            ...
            <MenuItem label="داشبورد" href="/dashboard" />
          </nav>
        </aside>
